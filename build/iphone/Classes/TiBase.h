...
// in simulator we redefine to format for ListAndPicker Developer console
...
{\
	NSString * exceptionName = [@"org.listandpicker." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.listandpicker";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIListAndPickerNativeItemNone = -1, 
	UIListAndPickerNativeItemSpinner = -2,
	UIListAndPickerNativeItemProgressBar = -3,
	
	UIListAndPickerNativeItemSlider = -4,
	UIListAndPickerNativeItemSwitch = -5,
	UIListAndPickerNativeItemMultiButton = -6,
	UIListAndPickerNativeItemSegmented = -7,
	
	UIListAndPickerNativeItemTextView = -8,
	UIListAndPickerNativeItemTextField = -9,
	UIListAndPickerNativeItemSearchBar = -10,
	
	UIListAndPickerNativeItemPicker = -11,
	UIListAndPickerNativeItemDatePicker = -12,
	
	UIListAndPickerNativeItemInfoLight = -13,
	UIListAndPickerNativeItemInfoDark = -14,
	
	UIListAndPickerNativeItemDisclosure = -15,
	
	UIListAndPickerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ListAndPicker instances of
