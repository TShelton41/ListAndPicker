 ...
 * Copyright (c) 2009-2011 by ListAndPicker, Inc. All Rights Reserved.
...
//@interface ListAndPickerObject : NSObject
//@end

@interface ListAndPickerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ListAndPickerObject class]])
		{
			for (NSString *key in [[(ListAndPickerObject*)o modules] allKeys])
			{
