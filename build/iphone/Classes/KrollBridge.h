...
@interface ListAndPickerObject : KrollCoverageObject {
#else
@interface ListAndPickerObject : KrollObject {
#endif
@private
...
extern NSString * ListAndPicker$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ListAndPickerObject *_listandpicker;
    KrollObject* console;
	BOOL shutdown;
