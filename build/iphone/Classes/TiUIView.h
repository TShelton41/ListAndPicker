...
/**
 Base class for all ListAndPicker views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ListAndPicker view hierarchy (such as wrapped iOS UIViews) was touched.
